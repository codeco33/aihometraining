...
public class eClassController {
	...
	public String EClassAppleyFormUpdate( EClassCategorySmall eClassCategorySmall
		...
		log.info("운동클래스 신청 수정폼에서 입력 받은 데이터 : {}",eClassIntroduce);
		log.info("운동클래스 신청 수정폼에서 입력 받은 데이터 : {}",eClassSectionTitle);
		log.info("운동클래스 신청 수정폼에서 입력 받은 데이터 : {}",eClassSectionCurriculum);
		log.info("운동클래스 신청 수정폼에서 입력 받은 데이터 : {}",eClassQuestion);
		log.info("운동클래스 신청 수정폼에서 입력 받은 데이터 : {}",eClassAnswer);
		log.info("운동클래스 신청 수정폼에서 입력 받은 데이터 : {}",eClassApproved);
